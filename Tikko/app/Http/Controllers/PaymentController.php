...
class PaymentController extends Controller
{
    ...
    public function index()
    {
        ...
        $tikkos = Tikko::select(
            'tikkos.id AS t_id',
            'tikkos.name AS t_name',
            'tikkos.description AS t_desc',
            'tikkos.currency AS t_curr',
            'tikkos.amount AS t_amount',
            'users.name AS u_name',
            'payments.tikko_id AS p_tId',
            'payments.payer_id AS p_pId',
            'tikkos.tikko_date AS t_date'
        )
...
// TODO: dynamic curency
    public function prepare(Request $request)
    {
        ...
        try {
            ...
            Payment::where('payer_id', Auth::id())
                ->where('tikko_id', $request->tikkoId)
